...
public class TreeWatcherNIO extends AbstractNIO2Watcher {
  ...
  private static final WatchEvent.Modifier HIGH;
  private static final WatchEvent.Modifier FILE_TREE;
  private static final WatchEvent.Modifier[] MODIFIERS;

  static {
    // try to set high sensitivity
    HIGH =
      getWatchEventModifier("com.sun.nio.file.SensitivityWatchEventModifier", "HIGH");
  ...
  private void register(Path dir) throws IOException {
    ...
    if (FILE_TREE == null) {
      ...
      LOGGER.debug(
        "WATCHING: ENTRY_CREATE, ENTRY_DELETE, ENTRY_MODIFY - fileTree,high {}",
        dir
      );
    }
