...
import com.github.hbh.hotspeed.watch.nio.TreeWatcherNIO;
import com.github.hbh.hotspeed.watch.nio.WatcherNIO2;
  ...
  public Watcher getWatcher() throws IOException {
    if (JAVA_VERSION >= 1.7) {
      ...
      throw new UnsupportedOperationException(
        "Watcher is implemented only for Java 1.7 (NIO2). " +
